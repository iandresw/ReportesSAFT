class PermisoOperacionReposirory:
    ...
    def recargar_datos(self, num_recibo: int):
        query = """
            SELECT Tra_PermOP.NumRecibo, Tra_PermOP.Identidad, Tra_PermOP.NoPermiso,  Contribuyente.Direccion,  Contribuyente.IdRepresentante, Tra_PermOP.Periodo, Tra_PermOP.Negocio, Tra_PermOP.Propietario,
                ...
                Contribuyente.rtn, Contribuyente.CodAldea, Contribuyente.idrepresentante , Contribuyente.Telefono , Tra_PermOP.Fecha
    ...
    def obtener_datos(self, num_recibo: int):
        query = """
         SELECT ReciboDet.NumRecibo, AvPgEnc.Identidad, Contribuyente.Direccion, Contribuyente.IdRepresentante, Contribuyente.rtn,
             ...
             CuentaIngreso_A.NombreCtaIngreso, Contribuyente.CodProfesion, Contribuyente.FechaNac, Contribuyente.Pnombre AS Negocio, Contribuyente.ClaveCatastro , Contribuyente.Telefono 
             ...
             Contribuyente_1.Pnombre, Contribuyente_1.SNombre, Contribuyente_1.PApellido, Contribuyente_1.SApellido, 
             CuentaIngreso_A.NombreCtaIngreso, Contribuyente.CodProfesion, Contribuyente.FechaNac, Contribuyente.Pnombre, Contribuyente.ClaveCatastro, Contribuyente.Telefono
    ...
    def insertar_tra_perm_ope(self, NoPermiso, Periodo, Identidad, Negocio, Propietario, Ubicacion, Actividad,  Observacion,  Fecha, CodAldea, NumRecibo):
        query = """INSERT INTO Tra_PermOP (NoPermiso, Periodo, Identidad, Negocio, Propietario, Ubicacion, Actividad,  Observacion,  Fecha, CodAldea, NumRecibo) 
        VALUES (?, ?, ?, ?, ?, ?, ?,  ?,  ?, ?, ?) """
        try:
            with self.conexion.cursor() as cur:
                cur.execute(query, (NoPermiso, Periodo, Identidad, Negocio, Propietario,
                            Ubicacion, Actividad,  Observacion,  Fecha, CodAldea, NumRecibo,))
                return True
        except Exception as e:
            return False
